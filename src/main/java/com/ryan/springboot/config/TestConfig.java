...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) {
		...
		Order o1 = new Order(null, Instant.parse("2025-05-31T18:00:00Z"), u1, OrderStatus.valueOf(1));
		Order o2 = new Order(null, Instant.parse("2025-05-28T14:05:00Z"), u2, OrderStatus.valueOf(2));
		Order o3 = new Order(null, Instant.parse("2025-05-24T18:30:00Z"), u1, OrderStatus.valueOf(4));
